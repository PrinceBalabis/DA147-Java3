...
public class TestScaleIcon {
    public static void main(String[] args) {
        ...
        ScaleIcon image1 = new ScaleIcon("M:/bilder/filmlogga.jpg", ScaleIcon.SCALE); // Ersätt med bild på din hårddisk
        ScaleIcon image2 = new ScaleIcon("M:/bilder/tandem1.jpg", ScaleIcon.FIT); // Ersätt med bild på din hårddisk
